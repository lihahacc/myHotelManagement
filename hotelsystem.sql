...
-- Records of clean
-- ----------------------------
INSERT INTO `clean` VALUES ('1', '1001', '1', '测试', '2022-12-20 21:42:53', 'c001', '王小花');
INSERT INTO `clean` VALUES ('2', '1003', '1', '测试', '2022-12-20 21:43:16', 'c001', '王小花');
...
-- Records of lodger
-- ----------------------------
INSERT INTO `lodger` VALUES ('31', '20221220211516', '身份证', '425220199806141214', '王先生', '男', '1', '15816019724', '', '2022-12-20 21:15:16');
INSERT INTO `lodger` VALUES ('32', '20221221154924', '身份证', '432456199706141216', '李先生', '男', '1', '13511684578', '', '2022-12-21 15:49:24');
...
-- ----------------------------
INSERT INTO `lodginginfo` VALUES ('20221220211516', '2022-12-20 21:13:58', '2022-12-21 00:00:00', '2d', '1006', '100', '已离店', null, '3');
INSERT INTO `lodginginfo` VALUES ('20221221154924', '2022-12-21 15:48:29', '2022-12-23 00:00:00', '3d', '1007', '100', '已离店', null, '1');
...
-- Records of maintain
-- ----------------------------
INSERT INTO `maintain` VALUES ('1', '1001', '1', '更换了左侧台灯灯泡', '2022-12-19 16:49:15', '肯师傅');
INSERT INTO `maintain` VALUES ('2', '1001', '1', '修复浴室天花板漏水状况', '2022-12-19 16:49:43', '肯师傅');
INSERT INTO `maintain` VALUES ('3', '1001', '1', null, '2022-12-19 17:35:10', '肯师傅');
INSERT INTO `maintain` VALUES ('4', '1002', '1', '修复电视没有信号的问题', '2022-12-19 17:36:49', '鲍师傅');
...
-- ----------------------------
INSERT INTO `reckoning` VALUES ('9', '20221220211516', '128', '2022-12-20 21:15:45', '3');
INSERT INTO `reckoning` VALUES ('10', '20221221154924', '256', '2022-12-21 16:26:34', '3');
...
-- Records of room
-- ----------------------------
INSERT INTO `room` VALUES ('1001', '03', '1', '空闲');
...
INSERT INTO `room` VALUES ('1006', '01', '1', '清洁中');
INSERT INTO `room` VALUES ('1007', '01', '1', '清洁中');
INSERT INTO `room` VALUES ('1008', '02', '1', '暂不开放');
...
-- Records of roomtype
-- ----------------------------
INSERT INTO `roomtype` VALUES ('01', '标准单人间', '128', '38', '128', '2022-12-17 10:56:17');
INSERT INTO `roomtype` VALUES ('02', '标准双人间', '158', '48', '158', '2022-12-17 11:20:33');
INSERT INTO `roomtype` VALUES ('03', '豪华单人间', '168', null, '168', '2022-12-17 11:22:26');
INSERT INTO `roomtype` VALUES ('04', '豪华双人间', '198', null, '198', '2022-12-17 11:22:33');
INSERT INTO `roomtype` VALUES ('05', '行政套房', '268', null, '268', '2022-12-17 11:22:24');
INSERT INTO `roomtype` VALUES ('06', 'test', '111', '0', '111', '2022-12-20 10:41:38');
INSERT INTO `roomtype` VALUES ('07', 'test2', '50', '10', '50', '2022-12-20 20:11:20');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '系统管理员', 'admin', null, '*', '2022-12-12 16:05:04');
INSERT INTO `user` VALUES ('3', 'candy', '肯迪', '456', '女', '1', '2022-12-12 17:35:00');
INSERT INTO `user` VALUES ('a001', 'andy01', '安迪1', '123', '女', '0', '2022-12-15 12:21:43');
INSERT INTO `user` VALUES ('a002', 'test', '王', '1234', '男', '0', '2022-12-20 21:10:10');
INSERT INTO `user` VALUES ('a015', 'andy02', '安迪2', '123', '男', '0', '2022-12-15 14:29:15');
INSERT INTO `user` VALUES ('b001', 'candy01', '肯迪01', '123', '女', '1', '2022-12-15 14:29:15');
INSERT INTO `user` VALUES ('b002', 'candy02', '肯迪02', '123', '女', '1', '2022-12-15 14:29:15');
INSERT INTO `user` VALUES ('b011', 'add_test', 'test', '13', '男', '1', '2022-12-16 23:07:52');
INSERT INTO `user` VALUES ('c001', 'wangxiaohua', '王小花', '123', '女', '2', '2022-12-16 21:07:07');
INSERT INTO `user` VALUES ('d001', 'ken', '肯师傅', '123', '男', '3', '2022-12-17 19:34:24');
INSERT INTO `user` VALUES ('d002', 'Bob', '鲍师傅', '123', '男', '3', '2022-12-17 20:33:18');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_realrs_list` AS select `d1`.`id` AS `id`,`d1`.`floor` AS `floor`,`d1`.`status` AS `status`,`d1`.`typename` AS `typename`,ifnull(`d2`.`status`,'无') AS `ldstatus`,ifnull(`d2`.`roomId`,'无') AS `ldroomid`,ifnull(`d2`.`lodgerName`,'无') AS `ldname` from ((select `rm`.`id` AS `id`,`rm`.`floor` AS `floor`,`rm`.`status` AS `status`,`rt`.`typename` AS `typename` from (`room` `rm` left join `roomtype` `rt` on((`rm`.`typeId` = `rt`.`id`)))) `d1` left join (select `lf`.`status` AS `status`,`lf`.`roomId` AS `roomId`,`ld`.`lodgerName` AS `lodgerName` from (`lodginginfo` `lf` left join `lodger` `ld` on(((`lf`.`id` = `ld`.`lodgingInfoId`) and (`ld`.`isRegister` = 1)))) where (`lf`.`status` = '入住中')) `d2` on((`d1`.`id` = `d2`.`roomId`))) ;
